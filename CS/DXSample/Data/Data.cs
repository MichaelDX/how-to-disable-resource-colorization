...
namespace DXSample.Data {
    #region Data classes
    public class SportEvent : BindableBase {        
        public int Id {
        ...
        public string CustomText { get { return $"{Location} - {Caption}"; }}
    }
    public class SportChannel : BindableBase {        
        public int Id {
            get { return GetValue<int>(); }
            set { SetValue(value); }
        }
        ...
        public TimeSpanRange NewsTimeRange {
            get { return GetValue<TimeSpanRange>(); }
            set { 
                SetValue(value);
                RaisePropertyChanged(() => HasNews);
            }
        }        
    }
    public class SportGroup : BindableBase {
        public int Id {
            get { return GetValue<int>(); }
            set { SetValue(value); }
        }
    ...
    public class SportChannelsDataHelper {
        ...
        public SportChannelsDataHelper(int dayCount) {
